...
class TestAuthenticationFlow:
    ...
    def test_(self, test_client):
        ...
        response = test_client.post("/auth/google", json={"code": ""})
...
class TestErrorHandling:
    ...
    def test_(self, test_client):
        ...
        response = test_client.put("/health")  # Health only accepts GET
        assert response.status_code == 405
        
    def test_(self, test_client):
        """Test validation error handling"""
        # Invalid request body
        response = test_client.post("/auth/google", json={"invalid": "data"})
